Amazon IVS Background Replacement Demo for Web includes the following third-party software/licensing:
...
\*\* IVS Real-Time Streaming Web Sample (HTML and JavaScript); version 1.0 -- https://codepen.io/amazon-ivs/project/editor/DYapzL
...
- For IVS Real-Time Streaming Web Sample (HTML and JavaScript) see also this
  required NOTICE:
  Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved. SPDX-
